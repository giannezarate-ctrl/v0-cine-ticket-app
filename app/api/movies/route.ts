...
export async function POST(request: Request) {
  try {
    ...
    const result = await sql`
      INSERT INTO movies (title, genre, duration, rating, synopsis, poster_url, trailer_url, release_date)
      VALUES (${title}, ${genre}, ${duration}, ${rating}, ${synopsis}, ${poster_url}, ${trailer_url}, ${release_date})
      RETURNING *
    `
